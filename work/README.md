...
Append evidence, resolution, and review entries; preserve earlier records and reports. Reviews are chronological, and the last entry governs current review status. Explicit resolutions remain required for every blocking finding from earlier reports.
